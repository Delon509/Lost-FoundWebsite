...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      ?>
<div class="caption">Current Pending Notices</div>	
<div id="table">
  ...
  $query="SELECT * FROM notice WHERE State='Pending';" ;
  ...
  while ( $row = mysqli_fetch_assoc($result) ){
    ...
    print("<span class=\"cell\" data-label=\"Response\"><a href=\"response.php?responseID={$row['NoticeID']}\">Response</a></span>");
    print("</div>");
    }
  ?>
</div>
