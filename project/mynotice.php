...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <div >
          <br>
          <br>
<button id="completed">Notice Created By Me</button>
<button id="pending">Notice Responded By Me</button>

<div id="completedtable">
<div class="caption">My notices</div>
<div id="table">
  ...
  $query="SELECT * FROM notice WHERE User_UserID='".$_COOKIE["loginID"]."';" ;
...
<div id="pendingtable">	
<div class="caption">Responded By Me</div>
<div id="table">
	<div class="header-row rows">
    <span class="cell primary">Notice ID</span>
    <span class="cell">Type</span>
  ...
  $query="SELECT * FROM notice inner join respond on notice.NoticeID = respond.Notice_NoticeID where respond.User_UserID=".$_COOKIE["loginID"].";";
  $result = dboperation($query);
  while ( $row = mysqli_fetch_assoc($result) ){
    print("<div class=\"rows\">");
    print("<input type=\"radio\" name=\"expand\">");
